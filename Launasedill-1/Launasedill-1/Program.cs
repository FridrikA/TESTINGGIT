    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("Greitt í lífseyrissjóð: {0}", Pens);
            Console.WriteLine("Greitt í stéttarfélag: {0}", Union);
            Console.WriteLine("Skattstofn {0}", SalaryAfterPens);
            Console.WriteLine("Skattur eftir frádrátt persónuafsláttar {0}", TaxTotal);
            Console.WriteLine("Útborguð laun eru {0} ", SalaryAfterTax);
